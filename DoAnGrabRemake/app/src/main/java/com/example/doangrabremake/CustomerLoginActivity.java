...
public class CustomerLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.customerLoginActivity), (v, insets) -> {
                ...
                mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(CustomerLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(!task.isSuccessful()){
                            Toast.makeText(CustomerLoginActivity.this, R.string.errorRegistration, Toast.LENGTH_SHORT).show();
                        }
                        // ===============
                        else{
                            // them vao database
            ...
            public void onClick(View v) {
                ...
                mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(CustomerLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(!task.isSuccessful()){
                            Toast.makeText(CustomerLoginActivity.this, R.string.errorSignIn, Toast.LENGTH_SHORT).show();
                        }
                        // ==================
